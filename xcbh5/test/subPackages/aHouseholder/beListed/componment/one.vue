	...
	<view class="me-container">
		<view class="form-card">
			...
			<view class="form-item">
				...
				<input class="form-input" v-model="formData.pickaddress" type="text" placeholder="请输入该菜市场五公里范围内提货点"
		...
		<view class="form-card">
			...
			<view class="form-item">
				...
				<view style="display: flex;">
					<input class="form-input" v-model.number="formData.price" placeholder="请输入预卖价"
						placeholder-style="color: #c0c4cc" />
					<input class="form-input" v-model.number="formData.presaleprice" type="number" placeholder="请输入市场价"
						placeholder-style="color: #c0c4cc" />
				</view>
			...
			<view class="form-item">
				...
				<view style="display: flex; justify-content: space-around;">
					<input class="form-input" v-model.number="formData.goodstotal" type="number" placeholder="请输入库存"
						placeholder-style="color: #c0c4cc " />
					<input class="form-input" v-model="formData.unit" type="text" placeholder="请输入单位"
						placeholder-style="color: #c0c4cc" />
				</view>
			...
			<view class="form-item">
				...
				<uni-datetime-picker type="date"  v-model="formData.sellbegintime" return-type="timestamp"/>
			</view>
			<view class="form-item">
				<view class="item-label">
					<text>上市结束时间</text>
				</view>
				<uni-datetime-picker type="date" return-type="timestamp"   v-model="formData.sellendtime"/>
			</view>
		...
		<view class="form-card">
			...
			<view class="form-item">
				...
				<input class="form-input" v-model="formData.contactpeople" type="text" placeholder="请输入联系人"
					placeholder-style="color: #c0c4cc" />
			</view>
			...
			<view class="form-item">
				...
				<input class="form-input" v-model="formData.contactphone" type="number" placeholder="请输入联系电话"
					placeholder-style="color: #c0c4cc" />
			</view>
