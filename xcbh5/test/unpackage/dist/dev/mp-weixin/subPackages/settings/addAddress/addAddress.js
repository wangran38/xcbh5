...
var _addAddress = _interopRequireDefault(__webpack_require__(/*! ./subPackages/settings/addAddress/addAddress.vue */ 813));
// @ts-ignore
...
/* harmony import */ var _addAddress_vue_vue_type_template_id_2fb4599a_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./addAddress.vue?vue&type=template&id=2fb4599a&scoped=true& */ 814);
/* harmony import */ var _addAddress_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./addAddress.vue?vue&type=script&lang=js& */ 816);
...
/* harmony import */ var _addAddress_vue_vue_type_style_index_0_id_2fb4599a_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./addAddress.vue?vue&type=style&index=0&id=2fb4599a&lang=scss&scoped=true& */ 818);
...
var component = Object(_D_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _addAddress_vue_vue_type_template_id_2fb4599a_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _addAddress_vue_vue_type_template_id_2fb4599a_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  "2fb4599a",
  null,
  false,
  _addAddress_vue_vue_type_template_id_2fb4599a_scoped_true___WEBPACK_IMPORTED_MODULE_0__["components"],
  renderjs
)
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "recyclableRender", function() { return _D_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_D_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_17_0_D_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_template_js_D_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_uni_app_loader_page_meta_js_D_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_index_js_vue_loader_options_D_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_style_js_addAddress_vue_vue_type_template_id_2fb4599a_scoped_true___WEBPACK_IMPORTED_MODULE_0__["recyclableRender"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "components", function() { return _D_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_D_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_17_0_D_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_template_js_D_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_uni_app_loader_page_meta_js_D_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_index_js_vue_loader_options_D_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_webpack_uni_mp_loader_lib_style_js_addAddress_vue_vue_type_template_id_2fb4599a_scoped_true___WEBPACK_IMPORTED_MODULE_0__["components"]; });
...
var fegionSelection = function fegionSelection() {
  __webpack_require__.e(/*! require.ensure | components/fegionSelection/fegionSelection */ "components/fegionSelection/fegionSelection").then((function () {
    return resolve(__webpack_require__(/*! @/components/fegionSelection/fegionSelection.vue */ 1063));
  ...
  methods: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 13:
                ...
                console.error('Failed to fetch cities:', _context.t0);
                return _context.abrupt("return", []);
              case 17:
              case "end":
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                _this4.districtList = response.data;
              ...
              case 13:
                ...
                console.error('Failed to fetch areas:', _context2.t0);
                return _context2.abrupt("return", []);
              case 17:
              case "end":
            ...
            switch (_context3.prev = _context3.next) {
              ...
              case 4:
                ...
                if (response.code === 200 && Array.isArray(response.data.listdata)) {
                  _this5.marketList = response.data.listdata.map(function (item) {
                    return item.marketname;
                  });
                  _this5.marketIdMap = response.data.listdata.reduce(function (map, item) {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 3:
                ...
                return _context4.abrupt("return", _this6.provinceList);
              case 7:
    ...
    bindMultiPickerChange: function bindMultiPickerChange(e) {
      ...
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee5() {
        var _this7$cityList$selec, selectedCityIndex, selectedCityId, _this7$districtList$_, _this7$overseasCountr, selectedCountryIndex, _selectedCityIndex, _this7$overseasCities;
        return _regenerator.default.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _this7.multiIndex = e.detail.value;
                if (!(_this7.selectedCountry === 'china')) {
                  _context5.next = 12;
                  break;
                }
                selectedCityIndex = _this7.multiIndex[1];
                selectedCityId = ((_this7$cityList$selec = _this7.cityList[selectedCityIndex]) === null || _this7$cityList$selec === void 0 ? void 0 : _this7$cityList$selec.id) || null;
                if (!selectedCityId) {
                  _context5.next = 10;
                  break;
                }
                _context5.next = 7;
                return _this7.fetchAreas(selectedCityId);
              case 7:
                _this7.area_id = ((_this7$districtList$_ = _this7.districtList[_this7.multiIndex[2]]) === null || _this7$districtList$_ === void 0 ? void 0 : _this7$districtList$_.id) || null;
                _context5.next = 10;
                return _this7.fetchMarkets(_this7.area_id);
              case 10:
                _context5.next = 20;
                break;
              case 12:
                ...
                selectedCountryIndex = _this7.multiIndex[0];
                _this7.overseasCountryId = ((_this7$overseasCountr = _this7.overseasCountries[selectedCountryIndex]) === null || _this7$overseasCountr === void 0 ? void 0 : _this7$overseasCountr.id) || null;
                _selectedCityIndex = _this7.multiIndex[1];
                if (!_this7.overseasCountryId) {
                  _context5.next = 20;
                  break;
                }
                _context5.next = 19;
                return _this7.fetchOverseasCities(_this7.overseasCountryId);
              case 19:
                _this7.overseasCityId = ((_this7$overseasCities = _this7.overseasCities[_selectedCityIndex]) === null || _this7$overseasCities === void 0 ? void 0 : _this7$overseasCities.id) || null;
              case 20:
              case "end":
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _context6.next = 4;
                return _this8.fetchProvinces();
              case 4:
                provinces = _context6.sent;
                _this8.multiArray[0] = provinces.map(function (item) {
                  return item.name;
                });
                ...
                _context6.next = 9;
                return _this8.fetchCities(provinces[0].id);
              case 9:
              ...
              case 22:
                ...
                _this8.multiArray[0] = countries.map(function (c) {
                  return c.shortname;
                });
                _this8.multiArray[1] = [];
                _this8.multiArray[2] = [];
              ...
              case 32:
                _this8.fetchMarkets(2313);
                _this8.selectedMarketIndex = 1;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                res = null;
                _this10.formData.area_id = _this10.area_id;
                if (_this10.isEdit) {
                  _context8.next = 8;
                  break;
                }
                _context8.next = 5;
                return _index.api.addMyAddress(_this10.formData);
              case 5:
                res = _context8.sent;
                _context8.next = 11;
                break;
              case 8:
                _context8.next = 10;
                return _index.api.editMyAddress(_this10.formData);
              case 10:
                res = _context8.sent;
              case 11:
                if (res.code == 200) {
